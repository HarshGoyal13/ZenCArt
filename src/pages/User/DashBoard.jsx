...
const DashBoard = () => {
  const [auth] = useAuth();
  return (
    <Layout title={"Dashboard - ZenCart"}>
    ...
    <div className='container mx-auto p-4'>
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-3/4 p-6 bg-white rounded-lg mt-4 md:mt-0 shadow-md border border-gray-200">
          <h2 className="text-3xl font-bold mb-4 text-pink-800">Welcome to  Dashboard</h2>
          <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
            <h3 className="text-xl font-semibold mb-2 text-gray-700">User Information</h3>
